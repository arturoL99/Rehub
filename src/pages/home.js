...
import { findAnnunciInEvidenza, sortAnnunci } from "../utils/Utils.js";
...
function Home() {
    ...
    useEffect(() => {
        contentfulClient.getEntries({
            ...
            .then((entry) => setImmobiliInEvidenza(findAnnunciInEvidenza(sortAnnunci(entry.items))))
            .catch(console.error);
    }, []);
    ...
    return (
        <>
            ...
            <section className="evidenceContainer">
                ...
                <InEvidenza immobile={immobiliInEvidenza ? immobiliInEvidenza[active] : ""} visible={true}/>
